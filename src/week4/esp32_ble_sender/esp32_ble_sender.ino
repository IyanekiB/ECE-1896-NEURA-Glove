 ...
 * 
 * Data Format (15 values, comma-separated):
 * flex1,flex2,flex3,flex4,flex5,qw,qx,qy,qz,ax,ay,az,gx,gy,gz
 * 
...
const float FLEX1_FLAT = 26991.0;  // Resistance when flat (Ohms)
const float FLEX2_FLAT = 26991.0;
const float FLEX3_FLAT = 26991.0;
const float FLEX4_FLAT = 26991.0;
...
void sendSensorData() {
    ...
    // Build comma-separated string (15 values)
    char buffer[256];
    snprintf(buffer, sizeof(buffer), 
             "%.3f,%.3f,%.3f,%.3f,%.3f,%.4f,%.4f,%.4f,%.4f,%.3f,%.3f,%.3f,%.3f,%.3f,%.3f",
             flex2_volt,  // Thumb
             flex5_volt,  // Index
             flex4_volt,  // Middle
             flex3_volt,  // Ring
